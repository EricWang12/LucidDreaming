...
DIR=outputs/multi_gen_ablation/
...
CUDA_VISIBLE_DEVICES=$gpu python launch.py --config $cfg_file --train --gpu 0  \
    ...
    system.data.eval_camera_distance=3.0 \
    system.prompt_processor.use_perp_neg=true system.recon_loss_weight=0.0 \
    # system.geometry.density_bias=blob_magic3d  dou \
