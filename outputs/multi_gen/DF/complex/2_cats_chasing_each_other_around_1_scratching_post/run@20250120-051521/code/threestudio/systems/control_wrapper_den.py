...
@threestudio.register("control-system-den")
        ...
        if self.cfg.scene_edit or self.cfg.recon_loss_weight > 0:
            with torch.no_grad():
                ...
                if hasattr(self, "model_copy"):  
                    ...
                    cache_rgb =  self.model_copy.forward(batch, recon=True, original_binaries=self.original_density)
                else:
                    cache_rgb = None
                threestudio.logger.setLevel("WARNING")
